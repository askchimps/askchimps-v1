...
describe('ChatMessageService', () => {
  ...
  describe('create', () => {
    ...
    it('should create a message successfully', async () => {
      ...
      const result = await service.create('org-123', 'chat-123', createDto);
  ...
  describe('findAll', () => {
    it('should return all messages for a chat', async () => {
      mockPrismaService.chat.findFirst.mockResolvedValue(mockChat);
      mockPrismaService.chatMessage.findMany.mockResolvedValue([mockMessage]);
    ...
    it('should throw NotFoundException if chat not found', async () => {
      ...
      await expect(service.findAll('org-123', 'chat-123')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should update a message successfully', async () => {
      mockPrismaService.chat.findFirst.mockResolvedValue(mockChat);
      mockPrismaService.chatMessage.findFirst.mockResolvedValue(mockMessage);
