...
export class ChatFollowUpMessageController {
                ...
                data: [
                    {
                        ...
                        organisationId: '01ARZ3NDEKTSV4RRFFQ69G5FAV',
                        content:
                            'Hello! We wanted to check in on your order status.',
                        sequence: 1,
                        delayInMinutes: 0,
                        isDeleted: false,
                        createdAt: '2024-01-15T10:30:00.000Z',
    ...
    @ApiOperation({
        ...
        description:
            'Retrieve a specific follow-up message template by its ID.',
    })
    @ApiParam({
        name: 'organisationId',
        description: 'Organisation ID (ULID format)',
        ...
        schema: {
            example: {
                data: {
                    ...
                    organisationId: '01ARZ3NDEKTSV4RRFFQ69G5FAV',
                    content:
                        'Hi! This is a gentle reminder about your pending payment.',
                    sequence: 1,
                    delayInMinutes: 60,
                    isDeleted: false,
                    createdAt: '2024-01-15T10:30:00.000Z',
