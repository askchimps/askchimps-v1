...
describe('ChatFollowUpMessageService', () => {
  ...
  describe('create', () => {
    ...
    it('should create a message successfully', async () => {
      ...
      mockPrismaService.chatFollowUpMessages.findFirst.mockResolvedValue(null);
    ...
    it('should allow super admin to create message', async () => {
      ...
      const result = await service.create(createDto, mockUserOrg.userId, true);
  ...
  describe('remove', () => {
    it('should soft delete a message successfully', async () => {
      ...
      expect(mockPrismaService.chatFollowUpMessages.update).toHaveBeenCalled();
    });
  });
});
