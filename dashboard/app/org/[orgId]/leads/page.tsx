...
export default function LeadsPage() {
    ...
    const { data: leadDetailData, isLoading: isLoadingDetail } = useQuery({
    ...
    const handleLeadSelect = (leadId: string) => {
        ...
        if (orgId) {
            ...
            router.replace(
                `/org/${orgId}/leads/${leadId}${queryString ? `?${queryString}` : ""}`,
                { scroll: false },
            );
        }
    };
    ...
    return (
        <DashboardLayout>
            <div className="flex h-[calc(100vh-4rem)] overflow-hidden">
                ...
                <div className="bg-card flex w-96 flex-col overflow-hidden border-r">
                    {/* Header */}
